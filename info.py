...
USERNAME = environ.get('USERNAME', "https://t.me/zsbhere") # ADMIN USERNAME
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Majority")
COLLECTION_NAME = environ.get('COLLECTION_NAME', '0')
#---------------------------------------------------------------
#---------------------------------------------------------------
#----------- There will be channel id add in all these ---------
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1001588212650'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002194850073')) # The movie you upload in it will be deleted from the bot.
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002439168100') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002439168100')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+IUtJOsISPsszYmJl') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
'adcash.in')
SHORTENER_API2 = environ.get("SHORTENER_API2", "a37d35def762b00679123e4bafab4be0416f43c6")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://telegra.ph/file/c286ecfe00953b9a3165a.jpg https://telegra.ph/file/c286ecfe00953b9a3165a.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://envs.sh/fgr.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/fgO.jpg'))
REACTIONS = ["😎"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://tender-sorcha-samantha12-6b045d05.koyeb.app/")
